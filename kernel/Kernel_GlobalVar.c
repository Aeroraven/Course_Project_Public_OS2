...
CHAR TestStack[KRNL_PROC_SINGLESTACK];
CHAR TestStack2[KRNL_PROC_SINGLESTACK];
CHAR TestStack3[KRNL_PROC_SINGLESTACK];
CHAR TestStack4[KRNL_PROC_SINGLESTACK];
...
KRNLM_VESA_DeclFrameBuffer(KRNL_CON_VFrameBuffer[KRNL_CON_COUNT]);

UBYTE KRNL_VIDEO_CHARMAP[128][VESA_FONT_COLS * VESA_FONT_ROWS];
